...
//				System.out.println("发送起始："+noFinishTask.getStart_file()+"  "+noFinishTask.getStart_length());
	...
	public interface FileListener{
		void getReceiveInfo(int read);
		void finishOneFile(String file_name);
		void getFilesInfo(String[] fileNames, long[] fileLength);
		void cancelConnect(int file, long length);
		void successConnect();
	}
